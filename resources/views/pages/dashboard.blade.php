    ...
    <div class="flex h-screen">
        ...
        <div class="flex-1 overflow-y-auto p-6">
            ...
            <div class="grid grid-cols-2 gap-4 mb-8">
                <div class="bg-blue-200 text-black p-4 flex items-center justify-between border-2 border-r-4 border-b-4 hover:border-r-3 hover:border-b-3 rounded-sm">
                    ...
                    <i class="fas fa-pencil-alt text-black">
                    </i>
                </div>
                <div class="bg-amber-200 text-black p-4 flex items-center justify-between border-2 border-r-4 border-b-4 hover:border-r-3 hover:border-b-3 rounded-sm">
                    <span class="text-2xl font-bold">
                        0
                    </span>
                    <span class="text-sm font-semibold">
                    ...
                    <i class="fas fa-clock text-black">
                    </i>
                </div>
                <div class="bg-green-200 text-black p-4 flex items-center justify-between border-2 border-r-4 border-b-4 hover:border-r-3 hover:border-b-3 rounded-sm">
                    <span class="text-2xl font-bold">
                        0
                    </span>
                    <span class="text-sm font-semibold">
                    ...
                    <i class="fas fa-check-square text-black">
                    </i>
                </div>
                <div class="bg-red-200 text-black p-4 flex items-center justify-between border-2 border-r-4 border-b-4 hover:border-r-3 hover:border-b-3 rounded-sm">
                    <span class="text-2xl font-bold">
                        0
                    </span>
                    <span class="text-sm font-semibold">
            ...
            <div class="border-2 border-dashed border-black p-8 text-center">
                ...
                <label class="flex flex-row items-center p-2 bg-black border-2 border-black rounded-sm shadow-md cursor-pointer w-full lg:w-1/4 justify-center mx-auto">
                    ...
                    <input type="file" id="uploadInput" class="hidden" accept="application/pdf" />
                </label>
            </div>
